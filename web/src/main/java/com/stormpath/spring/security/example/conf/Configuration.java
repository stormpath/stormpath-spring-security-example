...
/**
 * This configuration class is used to configure this application with default initialization values which can be overriden by
 * custom user values. The user's config file must be placed in "resources/config.ini".
 *
 * @since 0.3.0
 */
public class Configuration {
    ...
    static{
        ini = new OverridableIni();
        readIniData(ini, Configuration.class.getClassLoader().getResourceAsStream(Constants.DEFAULT_CONFIG_INI_FILE));
