...
public abstract class ProviderService extends AbstractService {
    ...
    public boolean hasProviderBasedAccountStore() {
        Application application = getStormpathClient().getResource(getStormpathAuthenticationProvider().getApplicationRestUrl(), Application.class);
     ...
     * <p/>
     * Returns a new {@link com.stormpath.sdk.provider.CreateProviderRequest provider-based directory creation request} instance.
     *
     * @return a new {@link com.stormpath.sdk.provider.CreateProviderRequest provider-based directory creation request} instance.
     */
