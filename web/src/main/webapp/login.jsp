<%--
  ~ Copyright (c) 2013 Stormpath, Inc. and contributors
  ~
...
<%@ page import="com.stormpath.spring.security.example.conf.Configuration" %>
...
<c:if test="${not empty error}">
    <p style="padding-top:5px;padding-bottom:10px;color:red">
        Your login attempt was not successful. <c:out value="${error}"/>
    </p>
</c:if>
        ...
        <td>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <img src="/resources/images/Red-signin_Long_base_44dp.png" onclick="googleLogin()"/>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <img src="/resources/images/facebook-login-button.png" onclick="facebookLogin()"/>
                    </td>
                </tr>
